...
userList = ["wk*********04", "Dw*****Y2", "cm******16", "lc********73", "pi****08", "wj********47", "ki******ar", "ki********03", "ah***da", "le******23", "zj********33", "mx*********25", "ST*****27", "qu****pc", "m1********83", "zh******13", "Be********ve", "Do**_X", "ds********77", "qu********66", "lo****ug", "yl**sg", "iw**p_", "zx*****13", "sa*****14"];
